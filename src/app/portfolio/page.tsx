...
const categories: { id: Category; label: string; description: string }[] = [
  ...
  { id: "web", label: "Web Applications", description: "Full-stack web solutions" },
  { id: "mobile", label: "Mobile Apps", description: "iOS & Android applications" },
  { id: "cloud", label: "Cloud Solutions", description: "Infrastructure & DevOps" },
  { id: "ai", label: "AI & ML", description: "Machine learning integration" },
  { id: "enterprise", label: "Enterprise Software", description: "Large-scale systems" },
];
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-gray-900 dark:text-white mb-6">
              Recent <span className="bg-gradient-to-r from-slate-800 to-cyan-500 bg-clip-text text-transparent">Work</span>
            </h1>
            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              A growing collection of software we've built for startups and established businesses.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="px-4 pb-16">
        <div className="max-w-5xl mx-auto">
          <AnimatePresence mode="wait">
            {isLoading ? (
              <div className="text-center py-24 text-gray-600 dark:text-gray-400">Loading projects…</div>
            ) : projects.length === 0 ? (
              <div className="text-center py-24">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">More Projects Coming Soon</h3>
                <p className="text-gray-600 dark:text-gray-400 mb-6">We're working on some exciting software projects. Check back soon to see our latest work.</p>
                <Link href="/contact" className="inline-flex items-center gap-2 px-6 py-3 bg-slate-900 dark:bg-white text-white dark:text-slate-900 rounded-lg font-medium hover:opacity-90 transition-opacity">
                  Work with us
                  <ArrowRightIcon />
                </Link>
              </div>
              ...
              <div className="grid gap-8 md:grid-cols-2">
                {projects.map((p, idx) => (
                  ...
                  >
                    <Link href={`/projects/${p.id}`} className="group block rounded-2xl overflow-hidden border border-gray-200/60 dark:border-gray-800/60 bg-white dark:bg-gray-950 hover:shadow-xl hover:border-slate-300 dark:hover:border-gray-700 transition-all duration-300">
                        ...
                        {p.technologies && p.technologies.length > 0 && (
                          <div className="flex flex-wrap gap-2 mb-4">
                            {p.technologies.slice(0, 4).map((tech, i) => (
                              <span key={i} className="px-2 py-1 text-xs bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 rounded border border-gray-200/20 dark:border-gray-700/20">
                                {tech}
                              </span>
                            ))}
                          </div>
      ...
      <section className="px-4 py-16 border-t border-gray-200/60 dark:border-gray-800/60">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-8">
            Let's talk about your software needs and see how we can help bring your ideas to life.
          </p>
          <Link href="/contact" className="inline-flex items-center gap-2 px-8 py-4 bg-slate-900 dark:bg-white text-white dark:text-slate-900 rounded-lg font-semibold hover:opacity-90 transition-opacity">
            Get in touch
            <ArrowRightIcon />
          </Link>
        </div>
