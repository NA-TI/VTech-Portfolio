      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        >
          ...
          <div className="flex items-center gap-3 mb-6">
            <div className={`w-12 h-12 rounded-xl ${getCategoryColor(project.category)} flex items-center justify-center text-white text-xl shadow-lg`}>
              {getCategoryIcon(project.category)}
            </div>
            <div className="flex items-center gap-2">
              <span className={`px-4 py-2 rounded-full text-sm font-semibold text-white ${getCategoryColor(project.category)} shadow-md`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
          ...
          >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {project.project_duration && (
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide">Timeline</p>
                      <p className="text-gray-900 dark:text-white">{project.project_duration}</p>
                    </div>
                  </div>
                )}
                ...
                {project.team_size && (
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide">Team Size</p>
                      <p className="text-gray-900 dark:text-white">{project.team_size} {project.team_size === 1 ? 'person' : 'people'}</p>
                    </div>
                  </div>
                )}
                ...
                {project.client && (
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide">Client</p>
                ...
                {project.technologies && project.technologies.length > 0 && (
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide">Technologies</p>
                      <p className="text-gray-900 dark:text-white">{project.technologies.join(', ')}</p>
                    </div>
                  </div>
                )}
              </div>
            ...
            {project.category === 'web' && (project.code_snippets || project.performance_metrics) && (
              <section className="bg-white/60 dark:bg-black/60 backdrop-blur-xl rounded-2xl p-8 shadow-lg border border-gray-200/50 dark:border-gray-700/50">
                <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-6">💻 Technical Details</h2>
                
                {project.code_snippets && (
                  <div className="mb-8">
                    <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-4">Key Features</h3>
                ...
                {project.performance_metrics && (
                  <div>
                    <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-4">Performance Metrics</h3>
                    <p className="text-gray-600 dark:text-gray-400 leading-relaxed">{project.performance_metrics}</p>
                  </div>
                )}
              </section>
            )}
            ...
            {(project.challenges || project.solutions || project.lessons_learned) && (
              <section className="bg-white/60 dark:bg-black/60 backdrop-blur-xl rounded-2xl p-8 shadow-lg border border-gray-200/50 dark:border-gray-700/50">
                <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-6">🚀 Project Journey</h2>
                
                {project.challenges && (
                  <div className="mb-8">
                    <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-4">Challenges</h3>
                ...
                {project.solutions && (
                  <div className="mb-8">
                    <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-4">Solutions</h3>
                    <p className="text-gray-600 dark:text-gray-400 leading-relaxed">{project.solutions}</p>
                  </div>
                )}
                
                {project.lessons_learned && (
                  <div>
                    <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-4">Lessons Learned</h3>
                    <p className="text-gray-600 dark:text-gray-400 leading-relaxed">{project.lessons_learned}</p>
                  </div>
                )}
              </section>
            )}
