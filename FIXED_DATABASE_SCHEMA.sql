-- ================================================================
-- VTECH PORTFOLIO - COMPLETE DATABASE SCHEMA (FIXED)
-- ================================================================
...
-- Insert default skills (FIXED ARRAY SYNTAX)
...
-- Insert sample projects (FIXED ARRAY SYNTAX)
...
('E-Commerce Platform', 'A comprehensive e-commerce solution built with Next.js, featuring user authentication, product catalog, shopping cart, payment processing with Stripe, and admin dashboard for inventory management.', 'Modern e-commerce platform with full payment integration', 'web', '/projects/ecommerce.jpg', 'https://demo-ecommerce.vtech.com', 'https://github.com/vtech-solutions/ecommerce', ARRAY['Next.js', 'React', 'TypeScript', 'Stripe', 'PostgreSQL', 'Tailwind CSS'], true, 'completed'),

('Task Management SaaS', 'A collaborative project management application with real-time updates, team collaboration features, file sharing, time tracking, and comprehensive reporting dashboard.', 'Team collaboration and project management tool', 'web', '/projects/task-management.jpg', 'https://tasks.vtech.com', 'https://github.com/vtech-solutions/taskapp', ARRAY['React', 'Node.js', 'Socket.io', 'MongoDB', 'Express', 'Material-UI'], true, 'completed'),

('Mobile Banking App', 'Secure mobile banking application with biometric authentication, transaction history, bill payments, money transfers, and real-time notifications.', 'Secure mobile banking with biometric auth', 'mobile', '/projects/banking-app.jpg', NULL, NULL, ARRAY['React Native', 'Node.js', 'PostgreSQL', 'JWT', 'Stripe', 'Push Notifications'], true, 'completed'),

('Brand Identity Package', 'Complete brand identity design for a fintech startup including logo design, color palette, typography system, brand guidelines, and marketing materials.', 'Complete brand identity for fintech startup', 'graphics', '/projects/brand-identity.jpg', NULL, NULL, ARRAY['Adobe Illustrator', 'Adobe Photoshop', 'Figma', 'Adobe InDesign'], false, 'completed'),

('3D Product Visualization', 'Photorealistic 3D product renders for an electronics company, including detailed materials, lighting setup, and interactive web viewer.', 'Photorealistic 3D product renders', '3d', '/projects/3d-products.jpg', 'https://3d-viewer.vtech.com', NULL, ARRAY['Blender', 'Substance Painter', 'Three.js', 'WebGL'], false, 'completed');
